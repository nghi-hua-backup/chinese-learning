...
| KBP-9 | Discrete knowledge units (vocab, grammar rules, pronunciation rules) go in `chinese-brain.md`. Practice sentences and dialogues go in `chinese-practice-bank.md`. Never mix these two files. **Exception:** Câu chào hỏi, tạm biệt, xin lỗi, cảm ơn, xã giao (social phrases) belong in **§ 6 "Câu thông dụng"** of `chinese-brain.md` per the brain guide — they may also appear in the practice bank, but must not be omitted from § 6. |
