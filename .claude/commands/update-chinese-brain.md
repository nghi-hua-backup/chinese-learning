# /update-chinese-brain

Cập nhật `chinese-brain.md` từ ảnh bài học mới.

## Cách dùng

```
/update-chinese-brain <tên_file_ảnh>
/update-chinese-brain IMG_8025.jpeg
/update-chinese-brain IMG_8025.jpeg IMG_8026.jpeg IMG_8027.jpeg
```
