...
| 66 | Due word list content | Word list rows show Chinese character (active script) on the left and Vietnamese meaning on the right; only reviewed (reps > 0) overdue cards appear — new cards absent |
